...
export default function NoiPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative h-[400px] overflow-hidden bg-primary/10">
        ...
        <div className="relative mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-4 text-center sm:px-6 lg:px-8">
          <h1 className="mb-4 text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl">Chi Siamo</h1>
          <p className="max-w-2xl text-xl text-foreground/90 text-balance">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-6 text-3xl font-bold text-foreground text-center">La Nostra Storia</h2>
      ...
      <section className="bg-muted/30 py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-12 text-center text-3xl font-bold text-foreground">I Nostri Valori</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-12 text-center text-3xl font-bold text-foreground">La Nostra Struttura</h2>

          <div className="grid gap-8 lg:grid-cols-2">
            <Card className="border-primary/20">
              <CardContent className="pt-6">
                <h3 className="mb-4 text-2xl font-semibold text-foreground">Primo Piano</h3>
            ...
            <Card className="border-primary/20">
              <CardContent className="pt-6">
                <h3 className="mb-4 text-2xl font-semibold text-foreground">Secondo Piano</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                    <span className="leading-relaxed">
      ...
      <section className="bg-muted/30 py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-6 text-3xl font-bold text-foreground">La Posizione Perfetta</h2>
