...
export default function PrenotaPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="bg-primary/5 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 lg:gap-12 lg:grid-cols-2">
            {/* Booking Form */}
            <div>
              <h2 className="mb-6 text-xl sm:text-2xl font-bold text-foreground">Dettagli Prenotazione</h2>
              <BookingForm />
            </div>
            ...
            <div className="space-y-6">
              <Card className="border-primary/20">
                <CardContent className="pt-6">
                  <h3 className="mb-4 text-lg sm:text-xl font-semibold text-foreground">Cosa è Incluso</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                      <span className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                        Camera con letti a castello tripli
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
              ...
              <Card className="border-primary/20 bg-muted/30">
                <CardContent className="pt-6">
                  <h3 className="mb-4 text-lg sm:text-xl font-semibold text-foreground">Tariffe</h3>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between border-b border-border pb-3">
                      <div>
                        <p className="font-medium text-foreground">Camera Condivisa</p>
                        <p className="text-xs sm:text-sm text-muted-foreground">Per persona a notte</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between border-b border-border pb-3">
                      <div>
                        ...
                        <p className="text-xs sm:text-sm text-muted-foreground">Intero piano a notte</p>
                      </div>
                      <p className="text-lg sm:text-xl font-bold text-primary">€180</p>
                    </div>
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-foreground">Settimana Completa</p>
                        <p className="text-xs sm:text-sm text-muted-foreground">7 notti, per gruppo</p>
                      </div>
                      <p className="text-lg sm:text-xl font-bold text-primary">€1.100</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-primary/20">
                <CardContent className="pt-6">
                  <h3 className="mb-4 text-lg sm:text-xl font-semibold text-foreground">Informazioni Utili</h3>
